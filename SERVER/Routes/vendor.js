...
router.post('/addProduct', CheckVendor, uploader.products.array("images", 20), (req, res, next) => {
    ...
    var originalPrice = parseInt(req.body.mrp);
    var offerPrice = parseInt(req.body.price);
    var discount = originalPrice - offerPrice;
    var discountPerc = Math.trunc(discount / originalPrice * 100);
...
var originalPrice = parseInt(data.mrp);
